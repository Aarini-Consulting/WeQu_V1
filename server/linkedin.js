...
Meteor.methods({
    ...
    'get.access.token'(redirect_uri,auth_code) {
            HTTP.call( 'GET', 'https://www.linkedin.com/oauth/v2/accessToken', 
            {
                params: {
                "grant_type": "authorization_code",
                "code":auth_code,
                "redirect_uri":redirect_uri,
                "client_id":Meteor.settings.public.LinkedInClientId,
                "client_secret":Meteor.settings.private.LinkedInPrivateId
                }
            },
            ( error, response ) => {
