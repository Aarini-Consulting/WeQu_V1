		...
		return (
          ...
          removeSelected={this.state.removeSelected}
				...
				<div className="checkbox-list">
					...
					<label className="checkbox">
						<input type="checkbox" className="checkbox-control" name="crazy" checked={crazy} onChange={this.toggleCheckbox.bind(this)} />
					...
					<label className="checkbox">
						<input type="checkbox" className="checkbox-control" name="rtl" checked={this.state.rtl} onChange={this.toggleCheckbox.bind(this)} />
